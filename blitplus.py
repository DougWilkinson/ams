...
class BlitClock:
	...
	def __init__(self, name, display, color=31, width=None, height=None, bitmap=RGB565, radius_factor=0.84, text=None, font=None, hand=5, effect="centered" ):
		...
		self.clock_radius = int(self.width if self.width < self.height else self.height * radius_factor / 2)
		self.text = text
		self.font = font
		self.hand = hand
		self.color = color
		...
		self.face_fb = FrameBuffer(bytearray(self.width * self.height * 2), self.width, self.height, self.bitmap )
		self.s_hand_fb = FrameBuffer(bytearray(self.width * self.height * 2), self.width, self.height, self.bitmap )
		self.m_hand_fb = FrameBuffer(bytearray(self.width * self.height * 2), self.width, self.height, self.bitmap )
		self.h_hand_fb = FrameBuffer(bytearray(self.width * self.height * 2), self.width, self.height, self.bitmap )
