...
# 10: uses webconfig and no hass_setup
...
oledclock = BlitClock("analogclock",  display=display, color=63488, text=weather, font=font, radius_factor=0.66, cy=145, dcy=255 )
